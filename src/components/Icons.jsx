...
const Icons = () => {
  ...
  <div className="PreFooter">
            <div className='itemic'>
                {Man}
                 <p> <b>Men's Collection</b> <br/>Premium Collection for Men</p>
               </div>
            <div className='itemic'>{kid} <p> <b>Kids Collection</b> <br/>Exclusive Clothes For Kids </p></div>
            <div className='itemic'>{Woman} <p> <b>Women's Collection</b> <br/>Premium Atire For Women </p></div>
        </div>
    </div>
  )
}
