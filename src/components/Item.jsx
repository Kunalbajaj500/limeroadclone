  ...
  return (
   <>
     <div className="PreFooter">
            <div className='itemi'>
                {repeatIcon}
                 <p> <b>Hassle-free replacement</b> <br/>10-day easy replacement policy on limeroad.com</p>
               </div>
            <div className='itemi'>{shieldIcon} <p> <b>100% secure payments</b> <br/> We support Cards, Wallets, EMI and COD</p></div>
            <div className='itemi'>{mapIcon} <p> <b>Vast service network</b> <br/> 1000 Limeroad service-centers across 600 cities</p></div>
        </div>
   </>
  )
}
